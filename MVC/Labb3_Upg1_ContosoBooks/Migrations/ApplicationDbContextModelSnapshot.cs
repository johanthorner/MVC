...
using Labb3_Upg1_ContosoBooks.Models;

namespace Labb3_Upg1_ContosoBooks.Migrations
{
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override void BuildModel(ModelBuilder builder)
        {
            ...
            builder.Entity("Labb3_Upg1_ContosoBooks.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("Labb3_Upg1_ContosoBooks.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
